...
Predicted_GPA = Decimal(str(class_1_grade + class_2_grade + class_3_grade + class_4_grade + class_5_grade + class_6_grade + class_7_grade + class_8_grade + class_9_grade + class_10_grade) / course_amount)

Final_GPA = Predicted_GPA.quantize(str("0.01"), rounding=ROUND_HALF_UP)
